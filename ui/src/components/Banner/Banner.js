...
import bannerWomen from './women_banner_light.jpg';
...
class Banner extends Component {
    ...
    render() {
        ...
        if (this.props.location.pathname === '/women'){
            banner = <Aux>
                <img alt="naybxrz econcept store woman girls vintage clothes hoodies shirts adidas nike carhartt northface patagonia rains"
                     src={bannerWomen}
        ...
        if (this.props.location.pathname === '/checkout'){
            banner = <Aux>
                <img alt="naybxrz econcept store vintage clothes carhartt obey supreme nike nocta bombers wutang chimodu hip hop culture streetwear lifestyle"
                     src={checkout}
                     className="BannerCheckout-Header-img"/>
                <div className="Banner-Container-Men">
                    <p> CHECKOUT </p>
                </div>
                <div className="Banner-Empty-Div"/>
